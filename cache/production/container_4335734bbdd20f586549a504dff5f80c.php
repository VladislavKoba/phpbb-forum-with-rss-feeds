...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'apwa.adunits.listener' => 'getApwa_Adunits_ListenerService',
            ...
            'cece74.sidebar.listener' => 'getCece74_Sidebar_ListenerService',
            ...
            'phpbb.pages.cron.task.text_reparser' => 'getPhpbb_Pages_Cron_Task_TextReparserService',
            ...
            'phpbb.pages.routing.loader' => 'getPhpbb_Pages_Routing_LoaderService',
            'phpbb.pages.text_reparser.page_text' => 'getPhpbb_Pages_TextReparser_PageTextService',
            ...
            'xaocz.menubar.listener' => 'getXaocz_Menubar_ListenerService',
        );
        $this->aliases = array(
    ...
    /**
     * Gets the public 'apwa.adunits.listener' shared service.
     *
     * @return \apwa\adunits\event\listener
     */
    protected function getApwa_Adunits_ListenerService()
    {
        return $this->services['apwa.adunits.listener'] = new \apwa\adunits\event\listener($this->get('user'), $this->get('config'), $this->get('config_text'), $this->get('template'));
    }
    ...
    /**
     * Gets the public 'cece74.sidebar.listener' shared service.
     *
     * @return \cece74\sidebar\event\listener
     */
    protected function getCece74_Sidebar_ListenerService()
    {
        return $this->services['cece74.sidebar.listener'] = new \cece74\sidebar\event\listener($this->get('controller.helper'), $this->get('template'), $this->get('config'), 'php');
    }
    ...
    protected function getCron_TaskCollectionService()
    {
        ...
        $instance->add('phpbb.pages.cron.task.text_reparser');
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('apwa.adunits.listener', 'apwa\\adunits\\event\\listener');
        $instance->addSubscriberService('cece74.sidebar.listener', 'cece74\\sidebar\\event\\listener');
        ...
        $instance->addSubscriberService('xaocz.menubar.listener', 'xaocz\\menubar\\event\\listener');
    ...
    /**
     * Gets the public 'paybas.recenttopics.functions' shared service.
     *
     * @return \paybas\recenttopics\core\recenttopics
     */
    ...
    /**
     * Gets the public 'paybas.recenttopics.listener' shared service.
     *
     * @return \paybas\recenttopics\event\listener
     */
    ...
    /**
     * Gets the public 'paybas.recenttopics.ucp_listener' shared service.
     *
     * @return \paybas\recenttopics\event\ucp_listener
     */
    ...
    /**
     * Gets the public 'phpbb.pages.admin.controller' shared service.
     *
     * @return \phpbb\pages\controller\admin_controller
     */
    protected function getPhpbb_Pages_Admin_ControllerService()
    {
        return $this->services['phpbb.pages.admin.controller'] = new \phpbb\pages\controller\admin_controller($this->get('cache.driver'), $this->get('controller.helper'), $this->get('language'), $this->get('log'), $this->get('phpbb.pages.operator'), $this->get('request'), $this->get('template'), $this->get('user'), $this, $this->get('dispatcher'), './', 'php');
    }

    /**
     * Gets the public 'phpbb.pages.controller' shared service.
     *
     * @return \phpbb\pages\controller\main_controller
     */
    protected function getPhpbb_Pages_ControllerService()
    {
        return $this->services['phpbb.pages.controller'] = new \phpbb\pages\controller\main_controller($this->get('auth'), $this, $this->get('controller.helper'), $this->get('language'), $this->get('template'), $this->get('user'));
    }

    /**
     * Gets the public 'phpbb.pages.cron.task.text_reparser' shared service.
     *
     * @return \phpbb\cron\task\text_reparser\reparser
     */
    protected function getPhpbb_Pages_Cron_Task_TextReparserService()
    {
        $this->services['phpbb.pages.cron.task.text_reparser'] = $instance = new \phpbb\cron\task\text_reparser\reparser($this->get('config'), $this->get('config_text'), $this->get('text_reparser.lock'), $this->get('text_reparser.manager'), $this->get('text_reparser_collection'));

        $instance->set_name('cron.task.text_reparser.phpbb_pages');
        $instance->set_reparser('phpbb.pages.text_reparser.page_text');

        return $instance;
    }

    /**
     * Gets the public 'phpbb.pages.entity' service.
     *
     * @return \phpbb\pages\entity\page
     */
    protected function getPhpbb_Pages_EntityService()
    {
        return new \phpbb\pages\entity\page($this->get('dbal.conn'), $this->get('config'), $this->get('dispatcher'), 'phpbb_pages', $this->get('text_formatter.s9e.utils'));
    }

    /**
     * Gets the public 'phpbb.pages.listener' shared service.
     *
     * @return \phpbb\pages\event\listener
     */
    protected function getPhpbb_Pages_ListenerService()
    {
        return $this->services['phpbb.pages.listener'] = new \phpbb\pages\event\listener($this->get('auth'), $this->get('controller.helper'), $this->get('language'), $this->get('phpbb.pages.operator'), $this->get('template'), $this->get('user'), 'php');
    }

    /**
     * Gets the public 'phpbb.pages.operator' shared service.
     *
     * @return \phpbb\pages\operators\page
     */
    protected function getPhpbb_Pages_OperatorService()
    {
        return $this->services['phpbb.pages.operator'] = new \phpbb\pages\operators\page($this->get('cache.driver'), $this, $this->get('dbal.conn'), $this->get('ext.manager'), $this->get('user'), 'phpbb_pages', 'phpbb_pages_links', 'phpbb_pages_pages_links');
    }

    /**
     * Gets the public 'phpbb.pages.routing.loader' shared service.
     *
     * @return \phpbb\pages\routing\page_loader
     */
    protected function getPhpbb_Pages_Routing_LoaderService()
    {
        return $this->services['phpbb.pages.routing.loader'] = new \phpbb\pages\routing\page_loader($this->get('dbal.conn'), 'phpbb_pages');
    }

    /**
     * Gets the public 'phpbb.pages.text_reparser.page_text' shared service.
     *
     * @return \phpbb\pages\textreparser\plugins\pages_text
     */
    protected function getPhpbb_Pages_TextReparser_PageTextService()
    {
        $this->services['phpbb.pages.text_reparser.page_text'] = $instance = new \phpbb\pages\textreparser\plugins\pages_text($this->get('dbal.conn'), 'phpbb_pages');

        $instance->set_name('phpbb_pages_text');
    ...
    protected function getRouting_Loader_CollectionService()
    {
        ...
        $instance->add('phpbb.pages.routing.loader');
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000032f14474000000003693d69e(
    ...
    protected function getTextReparserCollectionService()
    {
        ...
        $instance->add('phpbb.pages.text_reparser.page_text');
    ...
    /**
     * Gets the public 'xaocz.menubar.listener' shared service.
     *
     * @return \xaocz\menubar\event\listener
     */
    protected function getXaocz_Menubar_ListenerService()
    {
        return $this->services['xaocz.menubar.listener'] = new \xaocz\menubar\event\listener($this->get('auth'), $this->get('config'), $this->get('config_text'), $this->get('request'), $this->get('template'), $this->get('user'), $this->get('dbal.conn'), './', 'php');
    }
...
class phpbbtemplatetwiglexer_0000000032f14474000000003693d69e extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5ab8014314e4d925924842 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5ab8014314e65427168939 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5ab8014314e10148972777 = array(
    ...
    {
        $this->initializer5ab8014314e65427168939 && ($this->initializer5ab8014314e65427168939->__invoke($valueHolder5ab8014314e4d925924842, $this, 'set_environment', array('env' => $env), $this->initializer5ab8014314e65427168939) || 1) && $this->valueHolder5ab8014314e4d925924842 = $valueHolder5ab8014314e4d925924842;

        return $this->valueHolder5ab8014314e4d925924842->set_environment($env);
    }
    ...
    {
        $this->initializer5ab8014314e65427168939 && ($this->initializer5ab8014314e65427168939->__invoke($valueHolder5ab8014314e4d925924842, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5ab8014314e65427168939) || 1) && $this->valueHolder5ab8014314e4d925924842 = $valueHolder5ab8014314e4d925924842;

        return $this->valueHolder5ab8014314e4d925924842->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5ab8014314e65427168939 && ($this->initializer5ab8014314e65427168939->__invoke($valueHolder5ab8014314e4d925924842, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5ab8014314e65427168939) || 1) && $this->valueHolder5ab8014314e4d925924842 = $valueHolder5ab8014314e4d925924842;

        return $this->valueHolder5ab8014314e4d925924842->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5ab8014314e65427168939 = $initializer;
    }
    ...
    {
        $this->initializer5ab8014314e65427168939 && ($this->initializer5ab8014314e65427168939->__invoke($valueHolder5ab8014314e4d925924842, $this, '__get', array('name' => $name), $this->initializer5ab8014314e65427168939) || 1) && $this->valueHolder5ab8014314e4d925924842 = $valueHolder5ab8014314e4d925924842;

        if (isset(self::$publicProperties5ab8014314e10148972777[$name])) {
            return $this->valueHolder5ab8014314e4d925924842->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5ab8014314e4d925924842;
    ...
    {
        $this->initializer5ab8014314e65427168939 && ($this->initializer5ab8014314e65427168939->__invoke($valueHolder5ab8014314e4d925924842, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5ab8014314e65427168939) || 1) && $this->valueHolder5ab8014314e4d925924842 = $valueHolder5ab8014314e4d925924842;
    ...
    {
        $this->initializer5ab8014314e65427168939 && ($this->initializer5ab8014314e65427168939->__invoke($valueHolder5ab8014314e4d925924842, $this, '__isset', array('name' => $name), $this->initializer5ab8014314e65427168939) || 1) && $this->valueHolder5ab8014314e4d925924842 = $valueHolder5ab8014314e4d925924842;
    ...
    {
        $this->initializer5ab8014314e65427168939 && ($this->initializer5ab8014314e65427168939->__invoke($valueHolder5ab8014314e4d925924842, $this, '__unset', array('name' => $name), $this->initializer5ab8014314e65427168939) || 1) && $this->valueHolder5ab8014314e4d925924842 = $valueHolder5ab8014314e4d925924842;
    ...
    {
        $this->initializer5ab8014314e65427168939 && ($this->initializer5ab8014314e65427168939->__invoke($valueHolder5ab8014314e4d925924842, $this, '__clone', array(), $this->initializer5ab8014314e65427168939) || 1) && $this->valueHolder5ab8014314e4d925924842 = $valueHolder5ab8014314e4d925924842;

        $this->valueHolder5ab8014314e4d925924842 = clone $this->valueHolder5ab8014314e4d925924842;
    }

    public function __sleep()
    {
        $this->initializer5ab8014314e65427168939 && ($this->initializer5ab8014314e65427168939->__invoke($valueHolder5ab8014314e4d925924842, $this, '__sleep', array(), $this->initializer5ab8014314e65427168939) || 1) && $this->valueHolder5ab8014314e4d925924842 = $valueHolder5ab8014314e4d925924842;

        return array('valueHolder5ab8014314e4d925924842');
    }
    ...
    {
        return $this->initializer5ab8014314e65427168939;
    }
    ...
    {
        return $this->initializer5ab8014314e65427168939 && ($this->initializer5ab8014314e65427168939->__invoke($valueHolder5ab8014314e4d925924842, $this, 'initializeProxy', array(), $this->initializer5ab8014314e65427168939) || 1) && $this->valueHolder5ab8014314e4d925924842 = $valueHolder5ab8014314e4d925924842;
    }
    ...
    {
        return null !== $this->valueHolder5ab8014314e4d925924842;
    }
    ...
    {
        return $this->valueHolder5ab8014314e4d925924842;
    }
