...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000074b722d40000000048e94f77(
...
class phpbbtemplatetwiglexer_0000000074b722d40000000048e94f77 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5ab80141969ac087256080 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5ab80141969bf365702262 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5ab8014196980692565716 = array(
    ...
    {
        $this->initializer5ab80141969bf365702262 && ($this->initializer5ab80141969bf365702262->__invoke($valueHolder5ab80141969ac087256080, $this, 'set_environment', array('env' => $env), $this->initializer5ab80141969bf365702262) || 1) && $this->valueHolder5ab80141969ac087256080 = $valueHolder5ab80141969ac087256080;

        return $this->valueHolder5ab80141969ac087256080->set_environment($env);
    }
    ...
    {
        $this->initializer5ab80141969bf365702262 && ($this->initializer5ab80141969bf365702262->__invoke($valueHolder5ab80141969ac087256080, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5ab80141969bf365702262) || 1) && $this->valueHolder5ab80141969ac087256080 = $valueHolder5ab80141969ac087256080;

        return $this->valueHolder5ab80141969ac087256080->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5ab80141969bf365702262 && ($this->initializer5ab80141969bf365702262->__invoke($valueHolder5ab80141969ac087256080, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5ab80141969bf365702262) || 1) && $this->valueHolder5ab80141969ac087256080 = $valueHolder5ab80141969ac087256080;

        return $this->valueHolder5ab80141969ac087256080->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5ab80141969bf365702262 = $initializer;
    }
    ...
    {
        $this->initializer5ab80141969bf365702262 && ($this->initializer5ab80141969bf365702262->__invoke($valueHolder5ab80141969ac087256080, $this, '__get', array('name' => $name), $this->initializer5ab80141969bf365702262) || 1) && $this->valueHolder5ab80141969ac087256080 = $valueHolder5ab80141969ac087256080;

        if (isset(self::$publicProperties5ab8014196980692565716[$name])) {
            return $this->valueHolder5ab80141969ac087256080->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5ab80141969ac087256080;
    ...
    {
        $this->initializer5ab80141969bf365702262 && ($this->initializer5ab80141969bf365702262->__invoke($valueHolder5ab80141969ac087256080, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5ab80141969bf365702262) || 1) && $this->valueHolder5ab80141969ac087256080 = $valueHolder5ab80141969ac087256080;
    ...
    {
        $this->initializer5ab80141969bf365702262 && ($this->initializer5ab80141969bf365702262->__invoke($valueHolder5ab80141969ac087256080, $this, '__isset', array('name' => $name), $this->initializer5ab80141969bf365702262) || 1) && $this->valueHolder5ab80141969ac087256080 = $valueHolder5ab80141969ac087256080;
    ...
    {
        $this->initializer5ab80141969bf365702262 && ($this->initializer5ab80141969bf365702262->__invoke($valueHolder5ab80141969ac087256080, $this, '__unset', array('name' => $name), $this->initializer5ab80141969bf365702262) || 1) && $this->valueHolder5ab80141969ac087256080 = $valueHolder5ab80141969ac087256080;
    ...
    {
        $this->initializer5ab80141969bf365702262 && ($this->initializer5ab80141969bf365702262->__invoke($valueHolder5ab80141969ac087256080, $this, '__clone', array(), $this->initializer5ab80141969bf365702262) || 1) && $this->valueHolder5ab80141969ac087256080 = $valueHolder5ab80141969ac087256080;

        $this->valueHolder5ab80141969ac087256080 = clone $this->valueHolder5ab80141969ac087256080;
    }

    public function __sleep()
    {
        $this->initializer5ab80141969bf365702262 && ($this->initializer5ab80141969bf365702262->__invoke($valueHolder5ab80141969ac087256080, $this, '__sleep', array(), $this->initializer5ab80141969bf365702262) || 1) && $this->valueHolder5ab80141969ac087256080 = $valueHolder5ab80141969ac087256080;

        return array('valueHolder5ab80141969ac087256080');
    }
    ...
    {
        return $this->initializer5ab80141969bf365702262;
    }
    ...
    {
        return $this->initializer5ab80141969bf365702262 && ($this->initializer5ab80141969bf365702262->__invoke($valueHolder5ab80141969ac087256080, $this, 'initializeProxy', array(), $this->initializer5ab80141969bf365702262) || 1) && $this->valueHolder5ab80141969ac087256080 = $valueHolder5ab80141969ac087256080;
    }
    ...
    {
        return null !== $this->valueHolder5ab80141969ac087256080;
    }
    ...
    {
        return $this->valueHolder5ab80141969ac087256080;
    }
