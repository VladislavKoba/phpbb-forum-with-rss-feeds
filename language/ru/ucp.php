...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> 'Сайт «%1$s» является интернет-сообществом инвесторов и жителей ЖК Orange Park, доступ для обмена информацией в который имеют только они. Просматривать информацию на форуме могут также незарегистрированные пользователи.<br />
	<br />
	Заходя на форум ЖК Orange Park вы подтверждаете своё согласие со следующими условиями. Администрация форума оставляет за собой право изменять правила с последующим уведомлением пользователей. <br />
	<br />
	Вы соглашаетесь не размещать оскорбительных, угрожающих, клеветнических сообщений, порнографических сообщений, призывов к национальной розни и прочих сообщений, которые могут нарушить законы Украины, страны, которая предоставляет услуги хостинга для форума ЖК Orange Park, а также международное право. Попытки размещения таких сообщений приведут к немедленной блокировке вашего аккаунта, при этом ваш провайдер будет поставлен в известность. IP-адреса всех сообщений сохраняются для возможности проведения такой политики. Администрация форума ЖК Orange Park имеет право удалить, отредактировать, перенести или закрыть любое сообщение/любую тему по своему усмотрению. Введённая вами информация будет храниться в базе данных ЖК Orange Park, и не будет открыта третьим лицам без вашего разрешения. Администрация форума не несет ответственности за действия хакеров, которые могут привести к несанкционированному доступу к ней.
	',
