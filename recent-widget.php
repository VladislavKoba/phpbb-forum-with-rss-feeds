...
echo "<p  style='background-color:#F46D1D; color:white; margin:0;padding:10px; border-radius: 5px 5px 0 0;'>Лента Активности</p>";
echo "<table border='1' style='background-color:#ffffff'; width='100%'>";
$i = 0;
while($row = mysql_fetch_assoc($result))
{
    $i = $i+1; // This is to have different color for odd/even rows
    echo "<tr><td style='background-color:".(($i%2==1)?"#F2CEA5":"#FAE4CA")."; padding:5px;'>";
    // Time of post
