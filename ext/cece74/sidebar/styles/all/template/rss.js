(function(){
var a = window;
a.rssmikle_frame_width = a.rssmikle_frame_width ? a.rssmikle_frame_width : 140;
...
a.rssmikle_title_link = a.rssmikle_title_link == 'http://' ? '' : a.rssmikle_title_link;
a.rssmikle_title_bgimage = a.rssmikle_title_bgimage == 'http://' ? '' : a.rssmikle_title_bgimage;
a.rssmikle_item_bgimage = a.rssmikle_item_bgimage == 'http://' ? '' : a.rssmikle_item_bgimage;
...
var url = ('https:' == document.location.protocol ? 'https://' : 'http://') + 'feed.mikle.com/widget'
	...
	+ '&rssmikle_title_sentence=' + (a.rssmikle_title_sentence ? encodeURIComponent(a.rssmikle_title_sentence) : '')
        + '&rssmikle_title_link=' + (a.rssmikle_title_link ? encodeURIComponent(a.rssmikle_title_link) : '')
	...
	+ '&rssmikle_item_description_tag=' + (a.rssmikle_item_description_tag ? a.rssmikle_item_description_tag : '')
        + '&rssmikle_item_description_image_scaling=' + (a.rssmikle_item_description_image_scaling ? a.rssmikle_item_description_image_scaling : '')
        + '&rssmikle_item_date=' + (a.rssmikle_item_date ? a.rssmikle_item_date : '')
        + '&rssmikle_timezone=' + (a.rssmikle_timezone ? a.rssmikle_timezone : '')
        + '&datetime_format=' + (a.datetime_format ? a.datetime_format : '')
