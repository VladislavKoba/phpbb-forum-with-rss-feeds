...
$lang = array_merge($lang, array(
	...
	'ACP_MENUBAR_CONTENT_EXPLAIN'		=> 'С помощью данной формы вы можете задать структуру для вашего меню. Пример структуры меню с одним пунктом и выпадающим списком:<br /> <code class="syntaxhtml"><br />&lt;li&gt;&lt;a href="#link">Пункт 1&lt;/a&gt;<br />&nbsp;&nbsp;&nbsp;&lt;ul&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;li&gt;&lt;a href="#link"&gt;Пункт 1.1&lt;/a&gt;&lt;/li&gt;<br />&nbsp;&nbsp;&nbsp;&lt;/ul&gt;<br />&lt;/li&gt;</code>',
	...
	'ACP_MENUBAR_NOTE'					=> 'Пояснения по настройке меню',
